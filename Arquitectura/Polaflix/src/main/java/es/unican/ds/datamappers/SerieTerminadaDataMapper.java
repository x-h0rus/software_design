...
public class SerieTerminadaDataMapper {

	/**
	 * Metodo estatico para anhadirle al usuario una serie que ha terminado
	 * @param idSerie identificador de la serie que ha terminado el usuario
	 * @param idUsuario usuario que ha terminado la serie
	 * @throws SQLException
	 */
	public static void add(long idSerie, long idUsuario) throws SQLException {
		...
		String query = "INSERT INTO SeriesTerminadas VALUES (?,?)";
